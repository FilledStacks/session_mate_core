...
PackageInstruction _$PackageInstructionFromJson(Map<String, dynamic> json) {
  return _PackageInstruction.fromJson(json);
}

/// @nodoc
mixin _$PackageInstruction {
  ...
  @JsonKey(ignore: true)
  $PackageInstructionCopyWith<PackageInstruction> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $PackageInstructionCopyWith<$Res> {
  factory $PackageInstructionCopyWith(
          PackageInstruction value, $Res Function(PackageInstruction) then) =
      _$PackageInstructionCopyWithImpl<$Res, PackageInstruction>;
  @useResult
  $Res call({@NullableToTimeStampConverter() String? id, dynamic data});
}

/// @nodoc
class _$PackageInstructionCopyWithImpl<$Res, $Val extends PackageInstruction>
    implements $PackageInstructionCopyWith<$Res> {
  _$PackageInstructionCopyWithImpl(this._value, this._then);
